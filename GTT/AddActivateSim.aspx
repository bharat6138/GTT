<%@ Page Title="" Language="C#" MasterPageFile="~/GTT.Master" AutoEventWireup="true" CodeBehind="AddActivateSim.aspx.cs" Inherits="GTT.AddActivateSim" %>
        ...
        <article class="col-sm-12 col-md-12 col-lg-12">
             ...
             <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
                ...
                <div>
                    ...
                    <!-- widget content -->
                    <div class="widget-body" id="activateValidation">

                        <fieldset>
                            <legend>Activate SIM</legend>
                            <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 form-group">
                             ...
                             <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 form-group">
                                 <label class="control-label">Activate Date</label>
