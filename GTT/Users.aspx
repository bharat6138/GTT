<%@ Page Title="" Language="C#" MasterPageFile="~/GTT.Master" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="GTT.User" %>
        ...
        <div class="cd-tab-filter-wrapper">
            <div class="cd-tab-filter">
                <ul class="cd-filters">
                    ...
                    <li class="filter">
                        <a href="#0">
                            <h2 class="titl"><strong>USERS</strong></h2>
                        </a>
                    </li>

                    <li class="filterNewBtn">
                        <a id="add" href="AddUsers.aspx" class="btn btn-ribbon" data-title="add"><i class="fa fa-plus"></i>New</a>
                    </li>
                </ul>
                <!-- cd-filters -->
            </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-default btn-circle" data-toggle="tooltip" title="Delete"><i class="glyphicon glyphicon-floppy-remove"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>1</td>
