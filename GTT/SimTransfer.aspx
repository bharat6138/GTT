<%@ Page Title="" Language="C#" MasterPageFile="~/GTT.Master" AutoEventWireup="true" CodeBehind="SimTransfer.aspx.cs" Inherits="GTT.Transfer" %>
        ...
        <div class="cd-tab-filter-wrapper">
            <div class="cd-tab-filter">
                <ul class="cd-filters">
                    ...
                    <li class="filter">
                        <a href="#0">
                            <h2 class="titl"><strong>SIM Transfer</strong></h2>
                        </a>
                    </li>

                    <li class="filterNewBtn">
                        <a id="add" href="AddSimTransfer.aspx" class="btn btn-ribbon" data-title="add"><i class="fa fa-plus"></i> New</a>
                    </li>
                </ul>
                <!-- cd-filters -->
            </div>
