<%@ Page Title="" Language="C#" MasterPageFile="~/GTT.Master" AutoEventWireup="true" CodeBehind="ExtendValidity.aspx.cs" Inherits="GTT.ExtendValidity" %>
        ...
        <div class="cd-tab-filter-wrapper">
            <div class="cd-tab-filter">
                <ul class="cd-filters">
                    ...
                    <li class="filter">
                        <a href="#0">
                            <h2 class="titl"><strong>Extend Validity</strong></h2>
                        </a>
                    </li>

                    <li class="filterNewBtn">
                        <a id="add" href="AddExtendValidity.aspx" class="btn btn-ribbon" data-title="add"><i class="fa fa-plus"></i> New</a>
                    </li>
                </ul>
                <!-- cd-filters -->
            </div>
