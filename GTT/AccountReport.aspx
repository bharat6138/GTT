<%@ Page Title="" Language="C#" MasterPageFile="~/GTT.Master" AutoEventWireup="true" CodeBehind="AccountReport.aspx.cs" Inherits="GTT.AccountReport" %>
        ...
        <div class="cd-tab-filter-wrapper">
            <div class="cd-tab-filter">
                <ul class="cd-filters">
                    ...
                    <li class="filter">
                        <a href="#0">
                            <h2 class="titl"><strong>Account Report</strong></h2>
                        </a>
                    </li>

                    <li class="badgeTotal">
                        <strong>Total : </strong>
                        <span class="badge inbox-badge" >0</span>
                    </li>
                </ul>
                <!-- cd-filters -->
            </div>
