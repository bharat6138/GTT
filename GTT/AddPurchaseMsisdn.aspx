<%@ Page Title="" Language="C#" MasterPageFile="~/GTT.Master" AutoEventWireup="true" CodeBehind="AddPurchaseMsisdn.aspx.cs" Inherits="GTT.AddPurchaseMsisdn" %>
                ...
                <div>
                    ...
                    <div class="widget-body">
                        ...
                        <ul id="myTab1" class="nav nav-tabs bordered">
                          ...
                          <%--  <li>
                                <a href="#s2" data-toggle="tab"><i class="fa fa-fw fa-lg fa-gear"></i>Purchase SIM</a>
                            </li>--%>
                        ...
                        <div id="myTabContent1" class="tab-content padding-10">
                              <div class="tab-pane fade in active" id="s1">
                                  <fieldset>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 form-group">
                                        <label class="control-label">Purchase Number / Invoice Number</label>
                                   ...
                                   <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 form-group">
                                     ...
                                     <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 form-group">
                                       ...
                                       <a href="javascript:void(0);" class="btn btn-primary btn-xs"> <i class="fa fa-download"></i> Blank Sim Format</a>
                           ...
                           <%-- <div class="tab-pane fade" id="s2">
                                <fieldset>
                                      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 form-group">
                                        <label class="control-label">SIM No.</label>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 form-group">
                                       ...
                                       <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 form-group">
                                        <label class="control-label">PUK</label>
                                        <input class="form-control" placeholder="PUK" type="text">
                                    </div>
